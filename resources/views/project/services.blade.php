...
<div class="container-fluid contact_header">
     <img class="kanote" src="{{asset('project/img/cc/ka.png')}}">
         <div class="col-xs-12">
                <h1 style="line-height:100px;">{{__('main.service')}}</h1>
            </div>
            ...
            <ul class="nav nav-tabs" role="tablist">
                <li role="presentation" class="as active">
                    <a class="aa" href="#emergency" aria-controls="home" role="tab" data-toggle="tab">
                        <i class="fa flaticon-medical-ambulance14 fa-4x"></i><p>{{__("main.emer_care")}}</p></a>
                </li>

                <li role="presentation"><a href="#operation" aria-controls="profile" role="tab" data-toggle="tab"><i class="fa flaticon-medical-illness text-theme-colored fa-4x"></i><p>{{__("main.operation")}}</p></a></li>

                <li role="presentation"><a href="#outdoor" aria-controls="messages" role="tab" data-toggle="tab"><i class="fa flaticon-medical-stethoscope10 text-theme-colored fa-4x"></i><p>{{__("main.out_check")}} </p></a></li>
                <li role="presentation"><a href="#pharmacy" aria-controls="settings" role="tab" data-toggle="tab"><i class="fa flaticon-medical-tablets9 text-theme-colored fa-4x"></i><p>{{__("main.day_care")}}</p></a></li>
                <li role="presentation"><a href="#cancer" aria-controls="settings" role="tab" data-toggle="tab"> <i class="fa flaticon-medical-medical51
 fa-4x"></i><p>{{__("main.pharmacy")}}</p></a></li>
                <li role="presentation"><a href="#blood_test" aria-controls="settings" role="tab" data-toggle="tab"><i class="fa flaticon-medical-hospital35 text-theme-colored fa-4x"></i><p> {{__("main.blood_test")}}</p></a></li>
            </ul>
